...
changelog='Fix malformed locale language file. Added an update function. Fixed weather icons .Fixed detached GUI restart. Buy me a coffee if you like this plugin.'
